...
export const dataBooks: BookData[] = [
  ...
  },
  {
    ...
    desc: `A sabedoria transmitida pela obra é baseada nas práticas de sucesso dos antigos babilônicos, que embora sejam de uma época distante ainda são bastante úteis nos dias atuais, já que as leis que regiam o dinheiro há 6 mil anos seguem as mesmas, segundo o autor George S. Clason.
  ...
  },
  {
    ...
    desc: `E se os deuses do Olimpo estivessem vivos no século XXI? E se eles ainda se apaixonassem por mortais e gerassem filhos heróis? Segundo a lenda da Antiguidade, a maioria desses semideuses dificilmente passa da adolescência. Poucos conseguem descobrir sua identidade. 
  ...
  },
  {
    ...
    desc: `O Monte Olimpo está em perigo. Cronos, o perverso titã que foi destronado e feito em pedaços pelos doze deuses olimpianos, prepara um retorno triunfal. 
  ...
  },
  {
    ...
    desc: `O aguardado desfecho da premiada série de fantasia «Percy Jackson e os Olimpianos».<br/>
  ...
  },
  {
    ...
    desc: `Baseado nos romances escritos por Rick Riordan, a série acompanha o jovem Percy Jackson, um garoto que acaba de descobrir que é um semideus - metade humano, metade deus.
  ...
  },
  {
    ...
    desc: `Esse é o primeiro volume da ordem de livros de Os Heróis do Olimpo de Rick Riordan.
  ...
  },
  {
    ...
    desc: `Esse é o segundo volume da ordem deos livros de Os Heróis do Olimpo de Rick Riordan.
  ...
  },
  {
    ...
    desc: `Esse é o terceiro volume da ordem dos livros de Os Heróis do Olimpo de Rick Riordan.
  ...
  },
  {
    ...
    desc: `Esse é o quarto volume da ordem dos livros de Os Heróis do Olimpo de Rick Riordan.
  ...
  },
  {
    ...
    desc: `Esse é o quinto volume da ordem dos livros de Os Heróis do Olimpo de Rick Riordan.
  ...
  },
  {
    ...
    desc: `Qualquer pessoa pode conseguir alcançar a independência financeira. Poucas são as pessoas que já não se viram, pelo menos uma vez na vida, angustiadas por não conseguirem fazer o salário durar até o fim do mês.
  ...
  },
  {
    ...
    desc: `O sucesso financeiro tem menos a ver com a sua inteligência e muito mais a ver com o seu comportamento. E a forma como alguém se comporta é uma coisa difícil de se ensinar, mesmo para pessoas bastante inteligentes.
  ...
  },
  {
    ...
    desc: `Se as suas finanças andam na corda bamba, talvez esteja na hora de você refletir sobre o que T. Harv Eker chama de "o seu modelo de dinheiro" – um conjunto de crenças que cada um de nós alimenta desde a infância e que molda o nosso destino financeiro, quase sempre nos levando para uma situação difícil.
  ...
  },
  {
    ...
    desc: `A maioria dos garotos faria qualquer coisa para passar no Desafio de Ferro. Callum Hunt não é um deles. Ele quer falhar.
  ...
  },
  {
    ...
    desc: `Os estudantes do Magisterium estão aparentemente seguros. Sob os olhos observadores dos mestres, eles são ensinados a usar magia para levar a ordem a um mundo caótico.
  ...
  },
  {
    ...
    desc: `Há uma geração, Constantine Madden quase conseguiu o que nenhum outro mago jamais ousou sequer tentar: trazer os mortos de volta à vida. Mas o "quase" não teve um peso tão ruim. Afinal, ele foi capaz de se manter vivo, dentro de uma criança chamada Callum Hunt.
  ...
  },
  {
    ...
    desc: `O volume final, emocionante desta extraordinária série das autores best-sellers Holly Black e Cassandra Clare.
  ...
  },
  {
    ...
    desc: `“Se você conhece o inimigo e conhece a si mesmo, não precisa temer o resultado de cem batalhas. Se você se conhece, mas não conhece o inimigo, para cada vitória grande, sofrerá também uma derrota. Se você não conhece nem o inimigo e nem a si mesmo, perderá todas as batalhas…”
  ...
  },
  {
    ...
    desc: `Nesta obra, que é um clássico sobre pensamento político, o grande escritor Maquiavel mostra como funciona a ciência política.
  ...
  {
    name: "Ratobúrguer",
    desc: `Em Ratobúrguer, a protagonista Zoe tem uma vida triste: não tem amigos, não conta sequer com a simpatia da madrasta, e seu único companheiro, seu hamster de estimação, morreu. O pai dela está desempregado e passa o dia no bar. E, para piorar, ela também enfrenta uma rotina difícil na escola, pois o hobby favorito da valentona, Tina Trotts, é atormentá-la.
  ...
  },
  {
    ...
    desc: `Conheça o método simples e eficaz que vai proporcionar a vida dos sonhos — antes das 8 horas da manhã! Hal Elrod explica os benefícios de acordar cedo e desenvolver todo o nosso potencial e as nossas habilidades. 
  ...
  },
  {
    ...
    desc: `Nesta história que marcou gerações de leitores em todo o mundo, um piloto cai com seu avião no deserto do Saara e encontra um pequeno príncipe, que o leva a uma aventura filosófica e poética através de planetas que encerram a solidão humana.
  ...
  },
  {
    ...
    link: "https://go.hotmart.com/T89323370P",
  },
];
